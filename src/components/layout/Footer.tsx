      ...
      <div className="container mx-auto px-4">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
             {/* Twitter/X */}
             <a href={CONTACT_DETAILS.socials.twitter} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-border flex items-center justify-center hover:bg-primary transition-colors cursor-pointer text-muted-foreground hover:text-primary-foreground" aria-label="Follow us on Twitter">
             ...
             {/* LinkedIn */}
             <a href={CONTACT_DETAILS.socials.linkedin} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-border flex items-center justify-center hover:bg-primary transition-colors cursor-pointer text-muted-foreground hover:text-primary-foreground" aria-label="Follow us on LinkedIn">
                <span className="sr-only">LinkedIn</span>
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"></path></svg>
             </a>
             {/* Facebook */}
             <a href={CONTACT_DETAILS.socials.facebook} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-border flex items-center justify-center hover:bg-primary transition-colors cursor-pointer text-muted-foreground hover:text-primary-foreground" aria-label="Follow us on Facebook">
             ...
             {/* Instagram */}
             <a href={CONTACT_DETAILS.socials.instagram} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-border flex items-center justify-center hover:bg-primary transition-colors cursor-pointer text-muted-foreground hover:text-primary-foreground" aria-label="Follow us on Instagram">
